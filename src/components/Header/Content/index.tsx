...
export const Content: FC<ContentProps> = ({ onClick }) => {
	return (
		<div className='content-items ds-flex-center lg:ds-flex-end flow-row-nw lg:flow-col-nw gap-sm lg:p-inline-8 lg:p-block-10'>
